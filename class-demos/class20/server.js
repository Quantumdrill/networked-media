...
app.post("/upload", upload.single("theimage"), (req, res)=>{
  ...
  let data = {
    ...
    likes: 0 //create a number of likes property
  }
...
app.post("/like", (req,res)=>{
  ...
  let update = {
    $inc: {likes: 1} //nedb syntax: makes likes + 1
  }

  database.update(query,update,{},(err,numUpdated)=>{
    res.redirect("/")
  })//update has 4 params: query to locate the item, how to update the item, options, callback
})
